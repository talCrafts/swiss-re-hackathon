import com.talCraft.personality.PersonalityService
 ...
 */
class PersonalitySpecs extends Specification {

    def "basic example test"() {
        given:
        ...
        when:
        Profile personality = service.extract(text);
        then:
        personality != null
